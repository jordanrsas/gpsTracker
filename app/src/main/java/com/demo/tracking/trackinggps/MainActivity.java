        ...
        switch (v.getId()) {
            case R.id.start:
                if (isLocationPermissionGranted()) {
                    ...
                    //Intent mIntent = new Intent(this, TrackerService.class);
                    //mIntent.putExtra("Latitude", Double.toString(mLastLocation.getLatitude()));
                    //mIntent.putExtra("Longitude", Double.toString(mLastLocation.getLongitude()));
                    //startService(mIntent);

                    //La idea es que enviara la posición cada n milisegundos,
                    // RTC_WAKEUP para que prenda la patnalla(aumenta el brillo);
            ...
            case R.id.end:
                ...
                //Detiene el servicio y el AlarmManager
